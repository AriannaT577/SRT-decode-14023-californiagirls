...
@Config
@Autonomous(name = "RedHPBack", group = "Autonomous")
public class RedHPBack extends LinearOpMode { //TheFuriousFapper
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d postshootPose = new Pose2d (new Vector2d(0, -50), 1.2);//after shooting
        Pose2d hpmovePose = new Pose2d (new Vector2d(44, -48), Math.PI*5/6);//after moving to hp
        Pose2d hpeatPose = new Pose2d (new Vector2d(45.5, -60), Math.PI*5/6);//after eatig hp
        ...
        TrajectoryActionBuilder hpmoveballs = drive.actionBuilder(postshootPose)
                .splineToSplineHeading(new Pose2d(0, -48, Math.PI), 0)

                .setTangent(0)
                .splineToLinearHeading(new Pose2d(44, -48, Math.PI*5/6), Math.PI/3
        ...
        TrajectoryActionBuilder hpeatballs = drive.actionBuilder(hpmovePose)
                ...
                .splineToLinearHeading(new Pose2d(45.5, -48, Math.PI*5/6), 0
                        , new TranslationalVelConstraint(200),null )
                .setTangent(0)
                .splineToLinearHeading(new Pose2d(45.5, -60, Math.PI*5/6), 3*Math.PI/2
                        , new TranslationalVelConstraint(40),null )
                ;

        TrajectoryActionBuilder hplastballs = drive.actionBuilder(hpeatPose)
                .splineToLinearHeading(new Pose2d(40, -60, Math.PI), Math.PI*7/4
                        , new TranslationalVelConstraint(200),null )
        ...
        TrajectoryActionBuilder park = drive.actionBuilder(postshootPose)
                .setTangent(Math.PI)
                .splineToLinearHeading(new Pose2d(20, -55, Math.PI/2), 0
                        , new TranslationalVelConstraint(200),null )
                ;

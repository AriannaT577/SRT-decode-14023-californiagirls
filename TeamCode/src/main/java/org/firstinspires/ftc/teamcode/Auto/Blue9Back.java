...
@Config
@Autonomous(name = "Blue9Back", group = "Autonomous")
public class Blue9Back extends LinearOpMode { //BackshotsTillBlueBalls
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d hplastballsPose = new Pose2d (new Vector2d(48, -60), Math.PI);//after eatig hp
        ...
        TrajectoryActionBuilder hppewballs = drive.actionBuilder(hplastballsPose)
                .setTangent((11*Math.PI)/6)
